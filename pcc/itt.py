...
def extract(text, asset_id):
    ...
    if re.search(r'(alternativ\w*(?:\s+\w+){0,3}\s+tilbud|parallelle\s+tilbud)',t,re.I) and re.search(r'(ikke\s*(mottas|tillates|aksepteres)|(mottas|tillates|aksepteres)\s*ikke)',t,re.I):
